...
Anschließend kühlen wir die Messanordnung auf eine Temperatur von $T=-19°$C ab. Dann schalten wir die Kühlvorrichtung ab, um bei steigender Temperatur die Intensitätsverläufe aufzunehmen. Dazu legen wir ein ansteigendes Magnetfeld an, um die Lorentz- und Dispersionskurven des Hanle-Effekts aufzunehmen.\\
...
In der zweiten Messreihe messen wir während des Abkühlens der Messanordnung. Etwaige Verzögerungen beim Einstellen der Temperatur verfälschen den Wert beim Abkühlen in die andere Richtung als beim Aufwärmen. Durch Messungen in beide Richtungen kann dieser Fehler nun minimiert werden. Beim Abkühlen starten wir bei $T=18°C$ und messen bis zu einer Temperatur von $T=-3°C$.
