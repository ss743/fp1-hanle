...
for(i in 1:N0){
  ...
  title(paste("Abk??hlvorgang - Nr. ",i," - T=",T0[i],"K; Pol=0??",sep=""))
  dev.off()
  chi0[i]=fit[5,1]
...
table0=paste(table0,endtable("Abk??hlvorgang, Polarisation: 0??",label="cold0"),sep="\n")
...
for(i in 1:N90){
  ...
  plotlorentz(fit,c(-6,6)*10^7)
  title(paste("Abk??hlvorgang - Nr. ",i," - T=",T90[i],"K; Pol=90??",sep=""))
  dev.off()
  chi90[i]=fit[5,1]
...
table90=paste(table90,endtable("Abk??hlvorgang, Polarisation: 90??",label="cold90"),sep="\n")
...
for(i in 1:N45){
  ...
  title(paste("Abk??hlvorgang - Nr. ",i," - T=",T45[i],"K; Pol=45??",sep=""))
  dev.off()
...
table45=paste(table45,endtable("Abk??hlvorgang, Polarisation: 45??",label="cold45"),sep="\n")
